...
export function LeaderboardPreview({ data, error = false }: { data: LeaderboardData | null; error?: boolean }) {
  ...
  return <div className="lg:border-l lg:border-line lg:pl-10">
    ...
    <Link className="mt-4 inline-block text-sm font-semibold text-coral underline decoration-coral/30 underline-offset-4 hover:decoration-coral" href="/leaderboard?period=week">Open leaderboard</Link>
  </div>;
}
