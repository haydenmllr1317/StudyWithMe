...
test("analytics parser keeps aggregate fields only", () => {
  const parsed = parseAnalyticsData({ scope: "circle", range: "7d", timezone: "America/Denver", totalSeconds: 3600, daily: [{ date: "2026-08-17", seconds: 3600, sessionId: "private" }], goals: [{ name: "LSAT", seconds: 3600, userId: "private" }], leaderboard: [] });
